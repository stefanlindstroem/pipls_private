...
The public provenance reference is the article and supplementary material identified by DOI
`10.1016/j.compchemeng.2025.109143`. The repository adaptation selects the named fiber-property
variables as predictors and the named pulp and handsheet properties as responses. Refiner-control
variables, specific refining energy, and the final `k` variable are not part of the model matrices.
