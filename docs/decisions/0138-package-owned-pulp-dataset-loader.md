...
Public user documentation must describe only implemented stages. In particular, this first decision
patch does not add `load_pulp()` to the living public API or claim that Pulp is already packaged.
