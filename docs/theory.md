...
See [`parameter_selection.md`](parameter_selection.md), [`path_analysis.md`](path_analysis.md), and
[`cross_validation.md`](cross_validation.md) for the implemented selection and validation
contracts.
