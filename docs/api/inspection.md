...
The Pi-PLS factorization helper is method-specific. Its $P$ and $Q$ arrays are orthonormal predictor
and response directions, its entries $d_k=D_{kk}$ are dilations, and the matching triplet defines
paired latent mode $k$. The latent-structure, biplot, observation, and
