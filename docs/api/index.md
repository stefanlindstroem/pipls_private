...
| [`PiPLSValidationReport`](path.md#pipls.PiPLSValidationReport) | transitional `search.validation_report(X, Y, ...)` | Support maintained consumers until the final report-API removal patch |
