...
- Consolidate wheel, source-distribution, and documentation validation around shared private
  ...
  manifests, declared files, and parseable SVG output rather than fixed source and page inventories.
