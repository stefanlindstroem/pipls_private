...
| `0119-manuscript-latent-geometry-generator.md` | synthetic-data generator | single deterministic Gaussian latent generator with manuscript-oriented immutable truth and explicit row splitting for train/test use |
