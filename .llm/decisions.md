...
- Decision 0140 implements search-owned `select()`; maintained consumers have migrated, and the
  residual path-level scalar selection methods remain temporarily only for final removal;
