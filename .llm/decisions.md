...
| `0159-documentation-cross-reference-architecture.md` | documentation cross-reference architecture | active four-patch documentation-navigation contract: stable dataset/publication/theory destinations followed by semantic cross-linking and regression protection |
