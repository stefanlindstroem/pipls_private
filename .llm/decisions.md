...
| `0157-near-saturated-synthetic-pls-comparison.md` | near-saturated synthetic PLS-family stress case | fixed deterministic 25-by-40, 10-response exploratory design now integrated into Example 03 with matched folds and exhaustive Pi-PLS rank coverage |
