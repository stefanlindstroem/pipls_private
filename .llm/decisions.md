...
| `0119-manuscript-latent-geometry-generator.md` | synthetic-data generator | single deterministic Gaussian latent generator returning `(X, Y)`, with explicit row splitting for train/test use |
...
| `0142-package-owned-reference-datasets.md` | package-owned reference datasets | closed named-loader and language-neutral package-resource contract for Pulp, Sugarcane, and Tobacco without a registry or duplicate active matrices |
...
| `0146-cv-mse-tolerance-selection.md` | CV-MSE tolerance selection and split-SD reporting | dual-tolerance minimum-CV-MSE component selection, descriptive split SD, and repeated-CV aggregation semantics |
...
| `0148-predictor-rank-tolerance-selection.md` | predictor-rank tolerance selection | constructor tolerances, immutable rank evidence, conditioned component rules, and adaptive tolerance-boundary refinement |
