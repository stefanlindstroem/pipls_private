...
| `0155-response-subspace-selection-policies.md` | response-subspace selection policies | implemented cross-covariance default plus an explicit least-squares/RRR-inspired software extension outside the peer-reviewed publication |
