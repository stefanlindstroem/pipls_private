...
3. add relative and absolute tolerance selection with complete immutable provenance — complete;
4. replace maintained SE error bars and language with SD across validation splits — complete;
...
Current status: **Patches 1–6 of 7 complete**. Patch 7 is the next increment.
