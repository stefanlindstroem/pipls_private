...
The benchmark layer now implements fixed-structure recovery and adaptive rank selection as
question-specific scripts; predictor-nuisance comparison with ordinary PLS is next. No block-aware
scaling API is designed or scheduled.
