...
source-distribution validation. Decisions 0058 and 0059 make the existing plotters
caller-embeddable and replace the Pi-PLS factor composite with separate $P$, $D$, $Q$, and $QD$
functions. Prediction diagnostics remain to be split before release preparation.
