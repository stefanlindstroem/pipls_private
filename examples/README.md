...
Examples are introduced with their corresponding tested API increments.
...
- `09_linnerud_real_data.py`: explicit pandas reading of separate real predictor and response tables.
